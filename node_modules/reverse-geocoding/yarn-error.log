Arguments: 
  /usr/local/Cellar/node/8.9.1/bin/node /usr/local/bin/yarn test
...
Trace: 
  ...
  Exit code: 2
  Command: sh
  Arguments: -c ./node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha -report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js
  Directory: /Users/shaozh/reverse-geocoding
  Output:
